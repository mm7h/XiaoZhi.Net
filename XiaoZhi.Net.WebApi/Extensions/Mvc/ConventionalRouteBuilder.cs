...
namespace XiaoZhi.Net.WebApi.Extensions.Mvc
{
    ...
    public class ConventionalRouteBuilder : Volo.Abp.AspNetCore.Mvc.Conventions.ConventionalRouteBuilder
    {
        public ConventionalRouteBuilder(IOptions<AbpConventionalControllerOptions> options) : base(options)
        {
        }
