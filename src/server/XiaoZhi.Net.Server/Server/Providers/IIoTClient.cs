...
namespace XiaoZhi.Net.Server.Providers
{
    internal interface IIoTClient : IProvider<Session>
    {
        ...
        Task ExecuteIoTCommandAsync(string iotDeviceComponentName, string functionName, IReadOnlyDictionary<string, object?> arguments, IReadOnlyList<IoTParameterInfo> parameterInfos, CancellationToken cancellationToken = default);
